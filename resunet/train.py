...
#     optimizer = torch.optim.Adam(model.parameters(), lr=hp.lr)
    ...
    train_path_input = "/workspace/dals_tf2/dataset/INbreast_mass_data/Train/*_input.npy"
    train_path_mask = "/workspace/dals_tf2/dataset/INbreast_mass_data/Train/*_mask.npy"
    valid_path_input = "/workspace/dals_tf2/dataset/INbreast_mass_data/Valid/*_input.npy"
    valid_path_mask = "/workspace/dals_tf2/dataset/INbreast_mass_data/Valid/*_mask.npy"
